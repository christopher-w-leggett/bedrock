 ...
 * This injector will work for single instances or parameterized Collections.
 *
 * This injector will look to the value of the property whose name is that of the annotated element and treating it
 * as an absolute or relative path, will get the Resource identified by the path (starting from the current resource
